...
- Deterministic fake-Codex tests cover scoped prompts plus malformed events, duplicate identity, timeout, output overflow, stale preparation, existing artifacts, and failed exits.
